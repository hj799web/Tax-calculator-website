<template>
  <div class="items-plan-list">
    ...
    <div class="items-grid">
      <div v-for="item in filteredItems" :key="item.key" class="item-card">
        ...
        <div class="item-actions">
          ...
          <button class="btn" @click="planItem(item)">Plan</button>
        </div>
      </div>
    </div>
...
.item-card { border: 1px solid #e5e7eb; border-radius: 10px; padding: 12px; background: #fff; }
