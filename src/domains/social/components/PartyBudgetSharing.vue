<template>
  <div class="party-budget-sharing bg-white rounded-lg shadow p-4 mb-4">
    <h3 class="text-lg font-semibold mb-2">
      Canadian Party Budget Approaches (2025)
    </h3>
    <p class="text-sm text-gray-600 mb-4">
      Explore how different parties would shape Canada's finances
    </p>
    ...
    <div class="grid grid-cols-3 gap-3">
      ...
      >
        ...
        >
          <h4 class="font-bold">
            {{ party.name.replace(' Budget 2025', '') }}
          </h4>
        </div>
    ...
    <div
      v-if="copySuccess"
      class="mt-3 text-green-600 text-sm flex items-center"
    >
      <svg
        class="w-4 h-4 mr-1"
        fill="none"
