<template>
  <div id="faq-2022-2023" class="section">
    ...
    <p>We update the calculator annually to reflect changes in tax rates, brackets, and government spending allocations. The current version uses 2022-2023 tax rates.</p>
    ...
    <p>The spending allocations are based on the Public Accounts of Canada, which provide detailed breakdowns of federal government expenditures.</p>
